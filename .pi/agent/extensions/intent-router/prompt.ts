...
export const CLASSIFY_RULES = [
	...
	"",
	"Schema:",
	'{"kind":"question"|"instruction","lane":"ops"|"code"|"terminal"|null,"level":"basic"|"adv"|null,"tool":"<tool-name>"|null,"needsCurrentThread":true|false}',
	"",
	"Rules:",
	"- question: user wants an explanation, status, or answer. No work to perform. lane, level, and tool MUST be null. needsCurrentThread false.",
	"- needsCurrentThread true: user is confirming, continuing, or answering the last assistant message (yes, ok, go, do it, proceed, continue). Stay on the current thread. tool MUST be null.",
...
export const DECISION_JSON_SCHEMA = {
	...
	required: ["kind", "lane", "level", "tool", "needsCurrentThread"],
